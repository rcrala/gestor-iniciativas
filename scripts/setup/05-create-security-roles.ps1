...
$roles = @(
    @{
        ...
        Matrix = [ordered]@{
            ...
            'pas_iniciativa_sistema'  = 'CRWD:B Ap:B AT:B'
    ...
    @{
        ...
        Matrix = [ordered]@{
            ...
            'pas_iniciativa_sistema'  = 'CRWD:L Ap:L AT:L'
