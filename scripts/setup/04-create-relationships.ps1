...
$relationships = @(
    ...
    # pas_sistema + bridge (G2 - issue #29)
    @{ SchemaName = 'pas_sistema_empresa';           ReferencingEntity = 'pas_sistema';        ReferencedEntity = 'pas_empresa';      LookupSchemaName = 'pas_Empresa';      LookupLogicalName = 'pas_empresa';      LookupDisplay = 'Empresa';                     DeleteBehavior = 'Restrict' }
    @{ SchemaName = 'pas_iniciativasistema_iniciativa'; ReferencingEntity = 'pas_iniciativa_sistema'; ReferencedEntity = 'pas_iniciativa'; LookupSchemaName = 'pas_Iniciativa'; LookupLogicalName = 'pas_iniciativa'; LookupDisplay = 'Iniciativa';               DeleteBehavior = 'Cascade' }
    @{ SchemaName = 'pas_iniciativasistema_sistema';    ReferencingEntity = 'pas_iniciativa_sistema'; ReferencedEntity = 'pas_sistema';    LookupSchemaName = 'pas_Sistema';    LookupLogicalName = 'pas_sistema';    LookupDisplay = 'Sistema';                  DeleteBehavior = 'Restrict' }
